...
ui <- shinyUInavbarPage((title = div(h3("Analysis of County Business Patterns Data", style= "margin: 0;", style = "color:#8B0000"), 
                                    h4("Generated by Huma and Rebecca", style= "margin: 0;", style="color:#8B0000"))),
                         setBackgroundColor(
